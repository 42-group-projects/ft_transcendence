...
export function GameResultOverlay({
    ...
    return (
        <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/10 p-4 backdrop-blur-sm">
            <div className="w-full max-w-sm border-2 border-neutral-600 p-6 text-center shadow-lg shadow-red-900/10 bg-yellow-100">
                ...
                <Link
                    href="/lobby"
                    className="mt-6 inline-flex w-full items-center justify-center bg-red-800 px-4 py-2.5 text-sm font-medium text- transition hover:bg-red-800"
                >
                    Return to Lobby
                </Link>
            </div>
