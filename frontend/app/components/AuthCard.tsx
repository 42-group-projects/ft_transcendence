  ...
  return (
    <div className="rounded-2xl border border-neutral-800 bg-neutral-900/90 p-8 shadow-2xl shadow-black/30">
      <div className="mb-8 text-center">
        <p className={`text-sm uppercase tracking-[0.3em] ${accentColorClassName}`}>{accentLabel}</p>
      ...
      <div className="mt-6 flex items-center justify-between text-sm text-neutral-400">{footer}</div>
    </div>
  );
}